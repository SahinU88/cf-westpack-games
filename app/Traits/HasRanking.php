...
trait HasRanking
{
    ...
    public static function individualRankingOpenWod252($division = false)
    {
        ...
        return $sortedScores->map(function ($score, $index)  use (&$rank, &$count, &$lastKey) {
            ...
            $signature = static::finalResultKeyOpenWod252and253($score);
    ...
    {
        // 1) Get all relevant scores for 25.3
        $scores =  Score::with(['user', 'user.team'])
            ->rankingOpenWod253($division)
            ->get();
    ...
    protected static function finalResultKeyOpenWod252and253($score): string
    {
