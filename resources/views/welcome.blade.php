<x-guest-layout>
    ...
    <p class="mt-12 text-lg font-medium text-pretty sm:text-xl/8 text-white/75">
        ...
        Nach dem die Anmeldung geschlossen ist, werden alle Teilnehmenden in Teams aufgeteilt, welche dann gegeneinander
        antreten.
    </p>
    <div class="mt-10 flex items-center justify-center gap-x-6">
        <a href="{{ route('register') }}" class="flex gap-2 items-center text-sm/6 font-semibold bg-fuchsia-950 px-4 py-2 rounded-md hover:bg-fuchsia-900 hover:text-white">
            Jetzt anmelden
