<section class="w-full">
    ...
    <x-teams.layout :heading="$team->name" :subheading="$team->users->count() . ' ' . __('members.')" :teams="$teams">
        ...
        <div class="relative">
            <ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <li class="col-span-1 divide-y divide-gray-200 rounded-lg bg-white dark:bg-white/90 shadow-sm">
